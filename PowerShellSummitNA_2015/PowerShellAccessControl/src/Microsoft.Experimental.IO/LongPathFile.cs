...
namespace ROE.ThirdParty.Microsoft.Experimental.IO {
    ...
    public static class LongPathFile {
        ...
        public static void Delete(string path) {
            ...
            if (!Microsoft.Experimental.IO.Interop.NativeMethods.DeleteFile(normalizedPath)) {
        ...
        public static void Move(string sourcePath, string destinationPath) {
            ...
            if (!Microsoft.Experimental.IO.Interop.NativeMethods.MoveFile(normalizedSourcePath, normalizedDestinationPath))
                throw LongPathCommon.GetExceptionFromLastWin32Error();
        }
        ...
        public static void Copy(string sourcePath, string destinationPath, bool overwrite) {
            ...
            if (!Microsoft.Experimental.IO.Interop.NativeMethods.CopyFile(normalizedSourcePath, normalizedDestinationPath, !overwrite))
                throw LongPathCommon.GetExceptionFromLastWin32Error();
        }
        ...
        private static SafeFileHandle GetFileHandle(string normalizedPath, FileMode mode, FileAccess access, FileShare share, FileOptions options) {
            ...
            Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess underlyingAccess = GetUnderlyingAccess(access);
           
            SafeFileHandle handle = Microsoft.Experimental.IO.Interop.NativeMethods.CreateFile(normalizedPath, underlyingAccess, (uint)share, IntPtr.Zero, (uint)mode, (uint)options, IntPtr.Zero);
            if (handle.IsInvalid)
                throw LongPathCommon.GetExceptionFromLastWin32Error();
        ...
        private static Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess GetUnderlyingAccess(FileAccess access) {

            switch (access) {
                case FileAccess.Read:
                    return Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess.GenericRead;
                
                case FileAccess.Write:
                    return Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess.GenericWrite;

                case FileAccess.ReadWrite:
                    return Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess.GenericRead | Microsoft.Experimental.IO.Interop.NativeMethods.EFileAccess.GenericWrite;
